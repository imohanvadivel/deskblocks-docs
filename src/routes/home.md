...
Deskblocks includes a [Figma plugin](https://www.figma.com/community/plugin/1429884529544766993/figma-to-svelte) that generates production-ready code directly from your designs, powered by [Claude 3.5 Haiku](https://www.anthropic.com/claude/haiku). What sets it apart is that it doesn’t generate just any code. It uses Deskblocks components to build the UI. This ensures the features described above, including auto-theming, accessibility, and font management, work seamlessly out of the box.
...
If you already have a Svelte development setup for building extensions, you can install Deskblocks in your project.
...
The official [Zoho Extension Toolkit](https://www.npmjs.com/package/zoho-extension-toolkit) CLI does not support Deskblocks. To use Deskblocks, you’ll need to use either the provided starter template or your own custom build tool.

</Info>

## Usage

Import the required components from `deskblocks` and start building your Desk extension.
